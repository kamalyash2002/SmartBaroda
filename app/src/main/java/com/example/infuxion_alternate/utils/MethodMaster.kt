...
//        val financialKeywords = listOf("shopping", "airtel", "recharge", "disney", "xstream")
    ...
    suspend fun getAllInstalledApps(context: Context): List<AppModel> = withContext(Dispatchers.IO) {
    ...
    private fun filterFinancialApp(appList: List<AppModel>):List<AppModel>{
