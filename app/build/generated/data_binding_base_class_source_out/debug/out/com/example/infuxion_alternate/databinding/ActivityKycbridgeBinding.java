...
public final class ActivityKycbridgeBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityKycbridgeBinding(@NonNull LinearLayoutCompat rootView,
  ...
  @NonNull
  public static ActivityKycbridgeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityKycbridgeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_kycbridge, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityKycbridgeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityKycbridgeBinding((LinearLayoutCompat) rootView, buttonNo, buttonYes,
          imgPinIcon);
    }
