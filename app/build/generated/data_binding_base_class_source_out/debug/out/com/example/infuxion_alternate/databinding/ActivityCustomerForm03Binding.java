...
public final class ActivityCustomerForm03Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityCustomerForm03Binding(@NonNull LinearLayout rootView,
      ...
      @NonNull RelativeLayout rlTitle, @NonNull Spinner spState, @NonNull TextView tvHeadOne) {
  ...
  @NonNull
  public static ActivityCustomerForm03Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCustomerForm03Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_customer_form03, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCustomerForm03Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomerForm03Binding((LinearLayout) rootView, btnNext, company,
          monthlyRent, owned, parental, rented, residentialType, rlTitle, spState, tvHeadOne);
    }
